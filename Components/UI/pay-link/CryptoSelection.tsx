            ...
            {hasPaymentLinkData && (
                ...
                >
                    ...
                    >
                        {showAllCoins
                            ? t("showLess")
                            : t("showAll", {count: isMobile ? cryptoItems.length - 5 : cryptoItems.length - 9})}
                    </Text>
                </Box>
            )}
                        ...
                        sx={{
                            ...
                            backgroundColor:
                                paymentSettings.acceptedCryptoCurrency.length > 0
                                    ...
                                    : "",
                            border: `1px solid ${paymentSettings.acceptedCryptoCurrency.length > 0

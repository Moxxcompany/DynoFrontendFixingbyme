...
**IMPORTANT**: `NEXT_PUBLIC_SERVER_URL` and `NEXTAUTH_URL` MUST point to the pod's preview URL (e.g., `https://auth-url-deployment.preview.emergentagent.com/`). These are used for:
